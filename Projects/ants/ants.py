...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while dist <= self.max_range and not tmp_place is None and not tmp_place.is_hive:
            if len(tmp_place.bees) > 0 and dist >= self.min_range :
                return random_bee(tmp_place.bees)
            dist += 1
